...
function getResult(part) {
    ...
    switch (oper) {
        ...
        case 2: //2为减法
            ...
            break;
        case 3:
            result = (num1 * num2).toFixed(4);  //三为乘法
            currentNumber().value = result;
            break;
        case 4:
            ...
            result = parseFloat(num1 / num2).toFixed(4);  //防止浮点精度溢出
            currentNumber().value = result;
            break;
        default :
            break;
...
//求三角函数
function onSin() {
    num1 = (Math.sin(num1 * 2 * Math.PI / 360)).toFixed(4);
    currentNumber().value = num1;
    equalPressed = true;
}
function onCos() {
    num1 = (Math.cos(num1 * 2 * Math.PI / 360)).toFixed(4);
    currentNumber().value = num1;
    equalPressed = true;
}